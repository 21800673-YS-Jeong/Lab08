...
public class IntegratedConverter {
    ...
    /**
     * This main method runs 'run' method.
     * @param args Three Parameters are a numder for converting and two units.
     */
    ...
    /**
     * This method receives a number for converting, units input.
     * This method checks the unit you want to convert and the unit you want to convert.
     * This method runs Converters.
     * @param args
     * @see KMToMConverter
     * @see KMToMILEConverter
     * @see MILEToKMConverter
