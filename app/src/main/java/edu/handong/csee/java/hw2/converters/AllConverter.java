...
/**
 * When this class gets the value of KM, it changes to the value of M, MILE, and print them.
 * When this class gets the value of TON, it changes to the value of KG, G, and print them.
 * when this class gets neither KM nor TON, it print "AllConverter cannot support the measure!"
